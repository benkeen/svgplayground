...
$.main = function() {
  ...
  var t1 = $.query("#feColorMatrixType").get$on().get$change();
  $.getInterceptor$JSArray(t1).add$1(t1, $.changeFilterType);
  t1 = $.query("#feColorMatrixType_saturate input").get$on().get$change();
  $.getInterceptor$JSArray(t1).add$1(t1, $.changeSaturation);
  t1 = $.query("#feColorMatrixType_hueRotate input").get$on().get$change();
  $.getInterceptor$JSArray(t1).add$1(t1, $.changeHueRotate);
};

$.changeHueRotate = function(e) {
  var t1 = "<feColorMatrix type=\"hueRotate\" values=\"" + $.S(e.get$currentTarget().get$value()) + "\" />";
  $.filterElement.set$innerHTML(t1);
};
...
$.changeFilterType = function(e) {
  var selectedFilter, t1, sb;
  selectedFilter = e.get$currentTarget().get$value();
  t1 = $.query(".feColorMatrixTypeSettings").get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "hidden");
  if ($.getInterceptor$JSStringJSArray(selectedFilter).get$isEmpty(selectedFilter) !== true) {
    sb = $.StringBuffer_StringBuffer("");
    t1 = $.getInterceptor$JSArray(sb);
    t1.add$1(sb, "#feColorMatrixType_");
    t1.add$1(sb, selectedFilter);
    $.query(t1.toString$0(sb)).get$classes().remove$1("hidden");
    if ($.eqB(selectedFilter, "luminanceToAlpha"))
      $.filterElement.set$innerHTML("<feColorMatrix type=\"luminanceToAlpha\" x=\"0%\" y=\"0%\" />");
  }
};

$.changeSaturation = function(e) {
  var t1 = "<feColorMatrix type=\"saturate\" values=\"" + $.S(e.get$currentTarget().get$value()) + "\" />";
  $.filterElement.set$innerHTML(t1);
};
...
$.changeFilterType.call$1 = $.changeFilterType;
$.changeFilterType.$name = "changeFilterType";
$.changeSaturation.call$1 = $.changeSaturation;
$.changeSaturation.$name = "changeSaturation";
$.changeHueRotate.call$1 = $.changeHueRotate;
$.changeHueRotate.$name = "changeHueRotate";
...
//@ sourceMappingURL=svgExperiments.dart.js.map